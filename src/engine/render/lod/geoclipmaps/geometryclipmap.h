#ifndef NAGE_ENGINE_RENDER_LOD_GEOCLIPMAPS_GEOMETRYCLIPMAP_H_
#define NAGE_ENGINE_RENDER_LOD_GEOCLIPMAPS_GEOMETRYCLIPMAP_H_
...
#endif // NAGE_ENGINE_RENDER_LOD_GEOCLIPMAPS_GEOMETRYCLIPMAP_H_
